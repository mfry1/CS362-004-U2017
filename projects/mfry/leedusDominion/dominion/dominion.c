...
int newGreatHall(struct gameState *state, int handPos);
int newEmbargo(struct gameState *state, int handPos, int choice1);
int newOutpost(struct gameState *state, int handPos);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card )
    ...
    case great_hall:
      return newGreatHall(state, handPos);
    ...
    case embargo:
      return newEmbargo(state, handPos, choice1);

    case outpost:
      return newOutpost(state, handPos);
